        ...
        <header class="header" id="header">
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        <li class="nav__item">
                            <a href="/AdminAddingManagers" class="nav__link">Add Managers</a>
                        </li>
                        <li class="nav__item">
                            <a href="/viewallbranchmanagers" class="nav__link">View Managers</a>
                        </li>
                        <li class="nav__item">
                            <a href="/AdminViewingVolunteers" class="nav__link">View Volunteers</a>
                        </li>
                        
                        <li class="nav__item">
                            <a href="/AdminLogin" class="nav__link">Logout</a>
                        </li>
            ...
            <section class="home" id="home">
                ...
                <div class="home__container container grid">
                    <div class="home__data">
                        <span class="home__data-subtitle">Welcome <b><c:out value="${fullname}"></c:out> (Admin),</b></span>
