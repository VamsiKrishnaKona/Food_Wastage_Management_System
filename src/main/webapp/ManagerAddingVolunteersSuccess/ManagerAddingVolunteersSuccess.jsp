...
<html lang="en">
    <head>
      <link rel="shortcut icon" href="ManagerAddingVolunteersSuccess/assets/img/favicon.png" type="image/png">
        ...
        <style>
            ...
            body
            {
              ...
              background-image: url('ManagerAddingVolunteersSuccess/assets/img/thank you.jpg');
            }
    ...
    {%block head %}
        ...
        <div class="login-box" >
            ...
            <h2><span style="font-size:15px">Volunteer has been successfully added to <br> <b>Help India NGO</b></span></h2>
