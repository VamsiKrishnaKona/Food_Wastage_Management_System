...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="ManagerValidateOTP/assets/style.css" />
    <link rel="stylesheet" href="ManagerValidateOTP/assets/blurt.min.css" />
      ...
      <div class="box">
        <div class="inner-box">
          ...
          <div class="forms-wrap">
            <form method="post" action="ManagerValidateOTP" autocomplete="off" class="sign-in-form">
              <div class="logo">
