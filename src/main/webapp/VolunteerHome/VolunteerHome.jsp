        ...
        <header class="header" id="header">
            <nav class="nav container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        <li class="nav__item">
                            <a href="/VolunteerViewingPickupOrders" class="nav__link">View Pickup Orders</a>
                        </li>
                        
                        <li class="nav__item">
                            <a href="/VolunteerViewingCompletedOrders" class="nav__link">View Completed Orders</a>
                        </li>
                        
                        
                        <li class="nav__item">
                            <a href="/VolunteerLogin" class="nav__link">Logout</a>
                        </li>
            ...
            <section class="home" id="home">
                ...
                <div class="home__container container grid">
                    <div class="home__data">
                        <span class="home__data-subtitle">Welcome <b><c:out value="${fullname}"></c:out> (Volunteer),</b></span>
