...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="DonarValidateOTP/assets/style.css" />
    <link rel="stylesheet" href="DonarValidateOTP/assets/blurt.min.css" />
      ...
      <div class="box">
        <div class="inner-box">
          ...
          <div class="forms-wrap">
            <form method="post" action="DonarValidateOTP" autocomplete="off" class="sign-in-form">
              <div class="logo">
              ...
              <div class="heading">
              <h3><small>Welcome Donar,</small></h3>
