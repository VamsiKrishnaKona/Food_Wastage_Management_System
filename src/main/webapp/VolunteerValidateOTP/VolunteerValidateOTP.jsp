...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="VolunteerValidateOTP/assets/style.css" />
    <link rel="stylesheet" href="VolunteerValidateOTP/assets/blurt.min.css" />
      ...
      <div class="box">
        <div class="inner-box">
          ...
          <div class="forms-wrap">
            <form method="post" action="VolunteerValidateOTP" autocomplete="off" class="sign-in-form">
              <div class="logo">
              ...
              <div class="heading">
              <h3><small>Welcome Volunteer,</small></h3>
                <h2><small><small><small>Enter OTP</small></small></small></h2>
              </div>
			...
			&emsp;&emsp;&emsp;&emsp;
<button class="glow-on-hover" type="button" onclick="redirect()">Resend OTP</button>
